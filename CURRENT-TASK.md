...
4. [x] Konkrete verborgene Produktionsursache identifizieren: `PdoLoginAttemptStore::ensureSchema()` führte vor jedem Throttle-Read Request-time-DDL aus; Shared-Hosting-DB verweigerte dies und der Login-Catch maskierte die Exception als 503.
