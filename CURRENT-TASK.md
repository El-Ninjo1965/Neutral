...
**Status:** ABGESCHLOSSEN UND DEPLOYED · DEVICE RETEST REQUIRED
...
9. [x] Commit/PR/Push main, CodeQL/FTPS/read-only Smoke terminal abwarten, `HEAD == origin/main` und sauberen Tree prüfen; keine destruktive Produktion.
