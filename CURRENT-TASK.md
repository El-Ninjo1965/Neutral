...
12. Vollständigen Abschlussbericht mit sechs Betreiber-Retest-Schritten nach `CHATGPT.md` schreiben. **OFFEN**
13. Alles committen/pushen; `HEAD == origin/main`, sauberer Tree, FTPS/CodeQL/weitere CI terminal erfolgreich und `CHATGPT.md` auf GitHub `main` verifiziert. **OFFEN**
