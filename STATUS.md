...
| Shared-Hosting-Deployment | TEILWEISE | aktueller Code erzwingt ausdrückliches Ziel und unveränderliche Hostnamenprüfung, bindet Löschzustand per SHA-256-Fingerprint, überträgt vollständig und reicht lftp-Secrets nur über stdin; finaler Lauf `33716676051` wurde wegen nicht passender Zertifikats-/Hostname-Identität vor Authentifizierung und Upload blockiert |
