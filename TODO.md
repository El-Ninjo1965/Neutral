...
- in der sicheren GitHub-Actions-Konfiguration `FTP_SSL_CHECK_HOSTNAME=true` setzen und den danach ausdrücklich konfigurierten FTPS-Workflow erfolgreich prüfen; CodeQL für Abschlusscommit `a800c960` ist bereits bestanden.
