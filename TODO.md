...
- Workflow reset: DONE
- P4 configurable landing page: SAFARI-FRAME/SETTINGS-FIX CODE-SEITIG ERLEDIGT / DEVICE RETEST REQUIRED
...
3. Execute the focused operator retest for Safari/iPad `<h1>TEST</h1>` in Dark/Light, compact User Settings, header theme persistence and Home/GPS/Warmstart regression. Status: PENDING / DEVICE RETEST REQUIRED
