...
const PUBLIC_SCRIPTS = [
    'public-path.js', 'user-module-access.js', 'public-module-state.js', 'api-client.js', 'ui-feedback.js', 'user-ui-design.js', 'homepage-cache.js', 'homepage-document.js', 'user-app.js', 'style.css'
];
...
const isStaticAsset = (pathname) => (
    ...
    || /\/(public-path|api-client|ui-feedback|user-ui-design|homepage-cache|homepage-document|user-app|user-module-access|public-module-state|style)\.(js|css)$/.test(pathname)
