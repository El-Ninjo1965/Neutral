...
const PUBLIC_SCRIPTS = [
    'public-path.js', 'user-module-access.js', 'api-client.js', 'user-ui-design.js', 'homepage-cache.js', 'homepage-document.js', 'user-app.js', 'style.css'
];
...
const isStaticAsset = (pathname) => (
    ...
    || /\/(public-path|api-client|user-ui-design|homepage-cache|homepage-document|user-app|user-module-access|style)\.(js|css)$/.test(pathname)
