...
| Permanenter Post-Deployment-Smoke | BESTANDEN | Commit `8846c96aabe1abe143b8f84295d97c7369296a67`: vollständige GitHub-/PHP-Tests, Paketbau, explizites FTPS-Deployment und anschließender rein lesender HTTP-Smoke bestanden; Commitstatus `production/ftps-http` ist erfolgreich. Geprüft wurden Root, SPA-Rewrite, Adminschutz, Status- und Modul-API, Viewer-GPS, interner PHP-Schutz, exakter Commit/Basispfad und die ausgelieferten Modulverträge. |
