...
- **GitHub:** Der Connector bestätigte Konto `El-Ninjo1965`, Repository `El-Ninjo1965/Neutral` und Pushrecht. Eine saubere 27-Dateien-Differenz wurde als Commit `a7af22953ec3af6accdf93c937025acfd69690c7` fast-forward nach `main` geschrieben. Der Workflowabruf lieferte für diesen und auch frühere bekannte Commits keine Läufe; daraus wird weder CodeQL- noch Deploymenterfolg abgeleitet.
- **Offen:** CodeQL-/Deploymentnachweis und rein lesende Live-Smokes; lokal fehlt `.env.deploy`, daher kein manueller Upload ohne Secretkontext. PHP-Prozesstest in einer Umgebung mit PHP nachholen. Der Cloud-Browser konnte wegen eines CDP-Timeouts keine öffentliche Liveprüfung ausführen.
