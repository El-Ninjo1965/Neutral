...
- **Connector-Nachweis:** Ein separater Abschlussjob setzt ausschließlich `production/ftps-http` auf Erfolg oder Fehler. Dadurch bleibt der Push-Workflow über den GitHub-Connector überprüfbar, ohne Actions-Logs oder Geheimnisse zu lesen.
