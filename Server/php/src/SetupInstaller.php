...
final class SetupInstaller
{
    ...
    {
        $paths = [
            $this->runtime->projectRoot() . '/Server/runtime/config/admin-users.json',
            $this->runtime->projectRoot() . '/Server/runtime/config/admin-roles.json',
            $this->runtime->projectRoot() . '/Server/runtime/config/admin-settings.json',
            $this->runtime->projectRoot() . '/Server/runtime/config/audit-log.json',
