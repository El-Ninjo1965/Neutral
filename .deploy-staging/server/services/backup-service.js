...
const snapshotRuntimeState = (framework) => {
  ...
  return {
    ...
    marketplace: framework && typeof framework.getMarketplaceState === 'function' ? framework.getMarketplaceState() : (framework && framework.loadAdminState ? framework.loadAdminState().marketplace : {}),
