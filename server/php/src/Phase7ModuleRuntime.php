...
final class Phase7ModuleRuntime
{
    ...
    {
        $manifests = [];
        $modulesDir = $this->projectRoot . '/webapp/app/modules';
        ...
        foreach ($entries as $entry) {
            ...
            $decoded['modulePath'] = 'webapp/app/modules/' . $entry;
            $decoded['manifestPath'] = 'webapp/app/modules/' . $entry . '/' . basename($manifestPath);
            $manifests[] = $decoded;
        }
