...
$expectedWebroot = $configuredPublicRoot !== '' ? $configuredPublicRoot : rtrim($projectRoot, "/\\") . '/server/public';
$webRootPath = in_array(basename($expectedWebroot), ['webroot', 'public'], true)
    ? $expectedWebroot
    : $expectedWebroot . '/public';
